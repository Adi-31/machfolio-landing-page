...
const Features = () => {
  return (
    <div className='bg-[#9BB1FF] text-white h-[1000px] sm:h-screen w-full flex items-center justify-center flex-col sm:flex-row gap-[50px] p-[20px] sm:p-[30px] md:p-40px sm:pl-[70px] md:pl-[100px]'>
      <div>
